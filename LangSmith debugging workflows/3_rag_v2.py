...
def split_documents(docs, chunk_size=400, chunk_overlap=150):
...
def build_vectorstore(splits):
    # Use all-MiniLM-L6-v2 model from Hugging Face
...
generator = pipeline(
    ...
    model="/Users/muhammad/Downloads/google-flan-t5-base",  # local path
    max_new_tokens=256,
    device="mps"  # use "cuda:0" if on NVIDIA GPU, or "cpu" if CPU-only
)
